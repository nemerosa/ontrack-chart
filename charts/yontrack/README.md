...
![Version: 5.2.0](https://img.shields.io/badge/Version-5.2.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 5.4.1](https://img.shields.io/badge/AppVersion-5.4.1-informational?style=flat-square)
...
| management.service.port | int | `8800` | Exposed port for the Yontrack management service |
...
| service.type | string | `"ClusterIP"` | Service type for the Yontrack service |
